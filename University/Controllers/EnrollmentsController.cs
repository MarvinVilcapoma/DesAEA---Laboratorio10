...
namespace University.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View(enrollment.ToList().Where(x=>x.Enabled==true));
        }
        ...
        {
            ViewBag.CourseID = new SelectList(db.Course.Where(x => x.Enabled == true), "CourseID", "Title");
            ViewBag.StudentID = new SelectList(db.Student.Where(x => x.Enabled == true), "StudentID", "LastName");
            return View();
        }
        ...
        public ActionResult Edit(int? id)
        {
            ...
            ViewBag.CourseID = new SelectList(db.Course.Where(x => x.Enabled == true), "CourseID", "Title", enrollment.CourseID);
            ViewBag.StudentID = new SelectList(db.Student.Where(x => x.Enabled == true), "StudentID", "LastName", enrollment.StudentID);
            return View(enrollment);
        }
